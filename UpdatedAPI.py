...
# Minimal CORS configuration for React
@app.middleware("http")
...
if __name__ == "__main__":
    print("\n" + "="*70)
    print(" 🎛️  CONTROL PANEL API SERVER ")
    print("="*70)
    print(" Endpoints:")
    print("  • Global pause:               POST http://localhost:8000/pause/?paused=true")
    print("  • React global pause:         POST http://localhost:8000/react/pause?paused=true")
    print("  • Spline pause:               POST http://localhost:8000/pause_spline/ (with JSON body)")
    print("  • Check global pause:         GET  http://localhost:8000/check_pause_state")
    print("  • React get state:            GET  http://localhost:8000/react/state")
    print("  • Check spline pause:         GET  http://localhost:8000/check_spline_pause_state/{spline_id}")
    print("  • Get all splines:            GET  http://localhost:8000/splines")
    print("  • Set speed:                  GET  http://localhost:8000/speed/{speed_value}")
